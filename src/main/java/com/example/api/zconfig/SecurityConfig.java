	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.formLogin().disable().httpBasic().disable().logout().disable().csrf().disable()
			...
			.and()
				...
				.antMatchers("/api/boards/regist/community").hasAuthority(MemberRoleEnum.MEMBER.getValue())
				.antMatchers("/api/boards/regist/qna").hasAuthority(MemberRoleEnum.ADMIN.getValue())
